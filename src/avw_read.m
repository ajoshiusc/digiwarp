...
if findstr('.hdr',fileprefix),
 %   fileprefix = strrep(fileprefix,'.hdr','');
    [epaatmp,fileprefix,eaa]=fileparts(fileprefix);fileprefix=fullfile(epaatmp,fileprefix);
end
if findstr('.img',fileprefix),
    %fileprefix = strrep(fileprefix,'.img','');
    [wqwqtmp,fileprefix,eaa]=fileparts(fileprefix);fileprefix=fullfile(wqwqtmp,fileprefix);
end
